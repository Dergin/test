...
public class SynchronizedArray<Element> {
    ...
    init(queueLabel: String? = nil) {
        queue = DispatchQueue(label: "com.prueba.synchronizedArray.\(queueLabel ?? "default")", attributes: .concurrent)
    }
}
...
public extension SynchronizedArray {
    ...
    ///
    /// - Parameter transform: A closure that accepts an element of this sequence as its argument and returns a non-optional value.
    /// - Returns: An array of the results of calling transform with each element of the sequence.
